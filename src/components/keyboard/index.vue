<template>
    <div class="keyboard" :style="{ marginTop: fillingNum + 'px'}">
        <v-button ref="dom_rotate_el" color="blue" size="s1" arrow="translate(0, 63px)" :top="0" :left="374"
            :label="rotation" :position="true" :active="keyboard['rotate']" />
        <v-button ref="dom_down_el" color="blue" size="s1" arrow="translate(0,-71px) rotate(180deg)" :top="180"
            :left="374" :label="labelDown" :active="keyboard['down']" />
        <v-button ref="dom_left_el" color="blue" size="s1" arrow="translate(60px, -12px) rotate(270deg)" :top="90"
            :left="284" :label="labelLeft" :active="keyboard['left']" />
        <v-button ref="dom_right_el" color="blue" size="s1" arrow="translate(-60px, -12px) rotate(90deg)" :top="90"
            :left="464" :label="labelRight" :active="keyboard['right']" />
        <v-button ref="dom_space_el" color="blue" size="s0" :top="100" :left="52" :label="labelDropSpace"
            :active="keyboard['drop']" />
        <v-button ref="dom_r_el" color="red" size="s2" :top="0" :left="140" :label="labelResetR"
            :active="keyboard['reset']" />
        <v-button ref="dom_p_el" color="green" size="s2" :top="0" :left="40"
            :label="(start || isPause) ? labelStartS : labelPauseP" :active="keyboard['pause']" />
    </div>
</template>
